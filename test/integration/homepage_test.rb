class HomepageTest < ActionDispatch::IntegrationTest
  ...
  test "shows upcoming events" do
    future_event = Event.create!( :description => "event in the future", :starts => Date.today + 30 )
    next_event   = Event.create!( :description => "the very next event", :starts => Date.today + 10 )
    past_event   = Event.create!( :description => "event in the past",   :starts => Date.today - 10 )
    visit root_path
