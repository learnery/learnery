...
#    end
    ...
    it "should not get new" do
      get :new, use_route: :learnery, event_id:  @topic.event_id 
  ...
  context "logged in user" do
    ...
    it "should get new" do
      get :new, use_route: :learnery, event_id:  @topic.event_id, use_route: :learnery
      assert_response :success
    end
    test "should create topic" do
      assert_difference('Topic.count') do
        post :create, use_route: :learnery, event_id:  @topic.event_id,  topic: { description: @topic.description, name: @topic.name, presented_by_id: @topic.presented_by_id, suggested_by_id: @topic.suggested_by_id }
      end
